...
**Category:** Clothing
**Worn as:** Single-leg sock/stocking, left leg (for asymmetric outfits).
**Asset count:** 22
...
const item = character.Appearance.AddItem(AssetGet("SocksLeft", "Socks0"));
```
