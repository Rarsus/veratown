...
export declare const AssetUpperOverflowAlpha: [number, number, number, number];
/** @type {[number, number, number, number]} */
export declare const AssetLowerOverflowAlpha: [number, number, number, number];
...
export declare namespace AssetPoseMapping {
    namespace BodyLower {
        let AllFours: "Hide";
        let Hogtied: "Hide";
        let Kneel: "Kneel";
 ...
 * @type {Activity[]}
 */
export declare var ActivityFemale3DCG: Activity[];
/**
 * Display order for activities.
 * @type {ActivityName[]}
 */
export declare let ActivityFemale3DCGOrdering: ActivityName[];
/**
 * 3D Custom Girl based fetishes
 * Modify PreferenceArousalFetishDefaultCompressedString if you add a new fetish
 * @type {Fetish[]}
 */
export declare var FetishFemale3DCG: Fetish[];
/**
 * A set with all available fetish names.
 */
export declare const FetishFemale3DCGNames: Set<FetishName>;
