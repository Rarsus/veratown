...
export class RoleplaychallengeGameRoom extends AdministrationLogic {
    ...
    constructor(conn: API_Connector, config: ConfigFile) {
        super({ inactivityKickEnabledOnlyBelowFreeSlotsCount: 5 }, config);
        this.conn = conn;
        ...
        this.registerCommand(
            ...
            (connection, args, sender) =>
                this.unregisterPlayer(
                    sender,
                    " due to withdrawing from the game.",
                ),
            `To unregister from the game`,
        );
        this.registerCommand(
            "next",
            (connection, args, sender) => this.handleNextCommand(args, sender),
        ...
        this.registerCommand(
            "extend",
            (connection, args, sender) => this.handleExtendCommand(sender),
            `To prolong a challenge 2 minutes before it ends`,
        );
        this.registerCommand(
            "beepme",
    ...
    readonly challenges: challenge[] = [
        {
            ...
            story3: [
                ...
                ", about loud noises from the other guests in the next room",
            ],
            role3: [],
            room_background: [
                "BDSMRoomRed",
        ...
        },
        {
            ...
            role1: [],
            story2: [
                "going shopping for a new (pick some item) in the local fetish store, meeting",
            ],
            role2: [
                "friend",
                "mistress",
        ...
        },
        {
            ...
            role2: [],
            story3: [
                ", at a beach that is allowing nudity, eventually finding out they are staying at the same beach hotel nearby",
            ],
            role3: [],
        ...
        },
        {
            ...
            role2: ["sales woman for kinky toys"],
            story3: [
                ", into her home, thinking that the person she is sharing the flat with is not here currently. Her flat mate is",
            ],
            role3: [],
            room_background: [
                "BeachHotel",
        ...
        },
        {
            ...
            role1: [],
            story2: [
                "going to the club for the first time together with her married wife",
            ],
            role2: [],
        ...
        },
        {
            ...
            role2: [],
            story3: [
                ", is into BDSM because she found something while helping her to move in",
            ],
            role3: [],
            room_background: [
                "BondageBedChamber",
        ...
        },
        {
            ...
            story2: [
                "getting a choice between taking her bad grade or receiving a special lesson from",
            ],
        ...
        },
        {
            ...
            role2: ["croupier"],
            story3: [
                ". The poor player just lost all the money she had with her tonight and is offered an alternative way of payment to stay in the dice game",
            ],
            role3: [],
        ...
        },
        {
            ...
            role1: [],
            story2: [
                "visiting a dear friend who is currently in therapy at the asylum, but after being let in she got lost, meeting",
            ],
            role2: ["patient", "nurse"],
            story3: [],
            role3: [],
        ...
        },
        {
            ...
            role1: [],
            story2: [
                "making it into the finals of the ever popular TV game show 'The kinkster', competing against",
            ],
            role2: [],
            story3: [
                ". To win the big prize, their task is to explain a kink of them to the audience in the room and why they love it, " +
        ...
        },
        {
            ...
            role1: [
                "club maid",
                "club member",
                "club mistress's pet girl",
                "asylum nurse",
            ],
            story2: [
                "who lost a bet and now got the seemingly impossible task to convince",
            ],
        ...
        },
        {
            ...
            story2: [
                "who is currently entertaining the audience with her latest show, selecting",
            ],
            role2: [],
        ...
        },
        {
            ...
            role1: [],
            story2: [
                "sneaking into the infamous cult of kink. But she was detected by",
            ],
        ...
        },
        {
            ...
            role1: ["patient"],
            story2: [
                "in therapy at the asylum, currently scheduled for a visit by",
            ],
            role2: ["doctor", "nurse", "lawyer"],
            story3: [", accompanied by"],
            role3: [
                "nurse in training",
                "medical student, doing her internship at the asylum",
            ],
            room_background: ["AsylumEntrance", "AsylumTherapy"],
        },
        {
            ...
            role1: ["actress"],
            story2: [
                "going to an audition for her next role. However, it is an audition for a fetish movie - a fact not known to her. She is greeted by",
            ],
            role2: ["director", "interviewer"],
            story3: [", accompanied by"],
            role3: [
                "young woman, doing an internship here",
                "actress, also applying for the role",
        ...
        },
        {
            ...
            role1: ["actress"],
            story2: [
                "going to an audition for her next role. However, it is an audition for a fetish movie - a fact not known to her. There she meets",
            ],
            role2: [
        ...
        },
        {
            ...
            story1: [],
            role1: [
                "inventor of fetish toys",
                "bondage club owner",
                "rope maker",
            ],
            story2: [
                "going to the bank to present her business plan for getting a larger investiment into her latest business idea. Inside, she is greeted by",
            ],
        ...
        },
        {
            ...
            story3: [
                ", secretly to uncover why she comes late so often. She follows her into what appears to be a fetish night club, where she spots her wife together with",
            ],
    ...
    aggregateVariantsOfAllChallenges() {
        ...
        for (let i = 0; i < arrayLength; i++) {
            if (
                this.challenges[i].players === 2 ||
                this.challenges[i].players === 3
            ) {
                let tmp =
                    this.traits.length *
                    this.traits.length *
                    (this.challenges[i].story1.length > 1
                        ? this.challenges[i].story1.length
                        : 1) *
                    (this.challenges[i].story2.length > 1
                        ? this.challenges[i].story2.length
                        : 1) *
                    (this.challenges[i].story3.length > 1
                        ? this.challenges[i].story3.length
                        : 1) *
                    (this.challenges[i].role1.length === 0
                        ? this.roles.length
                        : this.challenges[i].role1.length) *
                    (this.challenges[i].role2.length === 0
                        ? this.roles.length
                        : this.challenges[i].role2.length);
                if (this.challenges[i].players === 3) {
                    tmp *=
                        this.traits.length *
                        (this.challenges[i].role3.length === 0
                            ? this.roles.length
                            : this.challenges[i].role3.length);
                }
                int += tmp;
            } else {
                logger.error(
                    `Unsupported number of players in this.challenges[${i}]: ${this.challenges[i].players}.`,
                );
            }
        }
    ...
    playerGreeting(character: API_Character) {
        ...
        character.Tell(
            "Emote",
            `*a game by Claudia, room concept by Claudia & Clare, and bot by Jomshir. The game currently offers ` +
        ...
        character.Tell(
            "Chat",
            "NEWS: If you want to be notified when a game can be started, there is a new command for sending you a BEEP (see bot profile).",
        );
    }
...
`.trim();
    ...
    protected async onCharacterEntered(
        ...
        const oldPlayer = Array.from(this.players.values()).find(
        ...
        if (this.players.has(character)) {
            ...
            if (this.players.size === 0) {
                ...
                void this.conn.ChatRoomUpdate({
                    Description:
                        "[BOT] scripted multiplayer gameroom | manual in bot profile | READY",
    ...
    private async waitForNextRoundAsPlayerLeft() {
        ...
        this.conn.SendMessage(
            "Emote",
            `*GAME: As the player at turn has left the room, every registered player can ` +
        ...
        sender.Tell(
            ...
            `This is the current status of the game:` +
                `${
                    ...
                    this.gameState === "waiting_on_next_turn"
    ...
    async handleNextCommand(args: string, sender: API_Character) {
        if (!this.players.has(sender)) {
            ...
            if (this.players.size < 2) {
                this.conn.SendMessage(
                    "Emote",
                    `*GAME: The game needs a minimum of two registered players to start the next round.`,
                );
                return;
            }
            ...
            sender.Tell(
                "Whisper",
                `GAME: Cannot start, as a challenge is currently already in progress. You will be in the pool ` +
    ...
    handleExtendCommand(sender: API_Character) {
        if (
            this.players.has(sender) &&
            !this.playersVotingForChallengeExtension.has(sender) &&
            this.printedChallengeExtension
        ) {
            this.playersVotingForChallengeExtension.add(sender);
            if (
                this.playersVotingForChallengeExtension.size /
                    this.players.size >
                0.7
            ) {
                ...
                this.conn.SendMessage(
                    "Emote",
                    `*GAME: The current role play challenge was successfully extended by another 10 mins.`,
                );
                ...
                this.conn.SendMessage(
                    "Emote",
                    `*GAME: ${sender} likes the ongoing roleplay and has used '!extend'. To prolong ` +
    ...
    private Tick() {
        ...
        if (
            this.turnTimer - now <= 120_000 &&
            this.gameState === "waiting_on_roleplay_completion" &&
            !this.printedChallengeExtension
        ) {
            this.conn.SendMessage(
                "Emote",
                `*GAME: Two minutes remaining. Every registered player can now vote to extend the ` +
        ...
        if (now >= this.turnTimer) {
            if (this.gameState === "waiting_on_roleplay_completion") {
                ...
                this.conn.SendMessage(
                    "Emote",
                    `*GAME: The time for this roleplay challenge is over. Please bring the scene slowly to an end ` +
    ...
    async determineNextChallenge(players: string) {
        ...
        if (this.players.size < 3) {
            ...
            if (players.startsWith("2")) {
                ...
                number_of_next_round_participants =
                    this.challenges[index].players;
            }
        }
        ...
        if (
            this.players.size >=
            number_of_previous_round_participants +
                number_of_next_round_participants
        ) {
            let i = 0;
            while (i < number_of_next_round_participants) {
                ...
                if (
                    !this.active_players.includes(key) &&
                    !this.last_players.has(key)
                ) {
    ...
    async constructAndStartChallenge(index: number) {
        ...
        const name =
            this.challenges[index].room_background.length === 0
                ? this.getRandomElementFromArray(this.backgrounds)
                : this.getRandomElementFromArray(
                      this.challenges[index].room_background,
                  );
        await this.conn.ChatRoomUpdate({
            Description:
                "[BOT] scripted multiplayer gameroom | manual in bot profile | ONGOING RP",
            Background: name,
        });
        ...
        this.conn.SendMessage(
            "Emote",
            `*GAME: Here is the next roleplay challenge:` +
                `\n=======================================` +
                `\n${msg}` +
                `\n=======================================` +
        ...
        metric_gameStarted.labels({ challenge: index }).inc();
        logger.alert(msg);
    }
