...
export const VERATOWN_LOCATIONS_FALLBACK: VeratownLocationDoc[] = [
    ...
    },
    {
        ...
        type: "help_monitor" as const,
        region: {
            TopLeft: { X: 0, Y: 21 },
            BottomRight: { X: 0, Y: 21 },
        },
        data: { displayKey: "kidnappers_status", cooldownMs: 5000 },
        enabled: true,
        createdAt: Date.now(),
        updatedAt: Date.now(),
    },
    {
        ...
        data: { displayKey: "kidnappers_commands", cooldownMs: 5000 },
        enabled: true,
        createdAt: Date.now(),
        updatedAt: Date.now(),
    },
    {
        ...
        data: { displayKey: "kidnappers_guide", cooldownMs: 5000 },
        enabled: true,
        createdAt: Date.now(),
        updatedAt: Date.now(),
    },
