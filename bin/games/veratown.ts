...
export class Veratown {
    public static description = [
        ...
        "/bot dare <join|leave|start|turn|add|draw|pass|reset|list|help> - Join/leave, start/check turn, add, draw, pass, reset or (admin only) list dare/forfeit cards (if configured)",
