...
| Command routes          | `Veratown` owns `/bot` room commands; Casino and Dare use `GamePluginCommandRouter`                                                                                                                       | `KidnappersGameCommandController` registers private `/bot kg` and `/bot kidnappers` routes through the shared router; public chat is rejected                                                              | [#168](https://github.com/Rarsus/veratown/issues/168) |
